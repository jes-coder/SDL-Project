...
<body>
    ...
    <!-- Page Content -->
    <h1 style="text-align: center;">Showcasing</h1>
    <div class="showcase">
        <img src="images/product7.jpg" alt="Showcase 1">
        <img src="images/product8.jpg" alt="Showcase 2">
        <img src="images/product9.jpg" alt="Showcase 3">
